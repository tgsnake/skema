...
const Exceptions = {
  ...
  400: {
    ...
    BUSINESS_CONNECTION_INVALID: 'BadRequest.BusinessConnectionInvalid',
    BUSINESS_CONNECTION_NOT_ALLOWED: 'BadRequest.BusinessConnectionNotAllowed',
    ...
    BUTTON_INVALID: 'BadRequest.ButtonInvalid',
    ...
    CALL_PROTOCOL_LAYER_INVALID: 'BadRequest.CallProtocolLayerInvalid',
    ...
    CHANNEL_MONOFORUM_UNSUPPORTED: 'BadRequest.ChannelMonoforumUnsupported',
    ...
    CHARGE_ID_EMPTY: 'BadRequest.ChargeIdEmpty',
    CHARGE_ID_INVALID: 'BadRequest.ChargeIdInvalid',
    ...
    FORM_SUBMIT_DUPLICATE: 'BadRequest.FormSubmitDuplicate',
    ...
    FROZEN_PARTICIPANT_MISSING: 'BadRequest.FrozenParticipantMissing',
    ...
    GIFT_MONTHS_INVALID: 'BadRequest.GiftMonthsInvalid',
    GIFT_SLUG_EXPIRED: 'BadRequest.GiftSlugExpired',
    GIFT_SLUG_INVALID: 'BadRequest.GiftSlugInvalid',
    GIFT_STARS_INVALID: 'BadRequest.GiftStarsInvalid',
    ...
    HASH_SIZE_INVALID: 'BadRequest.HashSizeInvalid',
    ...
    INVOICE_INVALID: 'BadRequest.InvoiceInvalid',
    ...
    MEDIA_ALREADY_PAID: 'BadRequest.MediaAlreadyPaid',
    ...
    MONTH_INVALID: 'BadRequest.MonthInvalid',
    ...
    NOGENERAL_HIDE_FORBIDDEN: 'BadRequest.NogeneralHideForbidden',
    NOT_ELIGIBLE: 'BadRequest.NotEligible',
    NOT_JOINED: 'BadRequest.NotJoined',
    NO_PAYMENT_NEEDED: 'BadRequest.NoPaymentNeeded',
    ...
    PACK_TYPE_INVALID: 'BadRequest.PackTypeInvalid',
    PARENT_PEER_INVALID: 'BadRequest.ParentPeerInvalid',
    ...
    PAYMENT_CREDENTIALS_INVALID: 'BadRequest.PaymentCredentialsInvalid',
    PAYMENT_PROVIDER_INVALID: 'BadRequest.PaymentProviderInvalid',
    PAYMENT_REQUIRED: 'BadRequest.PaymentRequired',
    ...
    QUICK_REPLIES_BOT_NOT_ALLOWED: 'BadRequest.QuickRepliesBotNotAllowed',
    ...
    RANDOM_ID_EXPIRED: 'BadRequest.RandomIdExpired',
    ...
    REACTIONS_COUNT_INVALID: 'BadRequest.ReactionsCountInvalid',
    ...
    SELF_DELETE_RESTRICTED: 'BadRequest.SelfDeleteRestricted',
    SEND_AS_PEER_INVALID: 'BadRequest.SendAsPeerInvalid',
    SEND_MESSAGE_GAME_INVALID: 'BadRequest.SendMessageGameInvalid',
    ...
    STARGIFT_USER_USAGE_LIMITED: 'BadRequest.StargiftUserUsageLimited',
    ...
    STARS_AMOUNT_INVALID: 'BadRequest.StarsAmountInvalid',
    ...
    SUBSCRIPTION_ID_INVALID: 'BadRequest.SubscriptionIdInvalid',
    SUBSCRIPTION_PERIOD_INVALID: 'BadRequest.SubscriptionPeriodInvalid',
    SUGGESTED_POST_AMOUNT_INVALID: 'BadRequest.SuggestedPostAmountInvalid',
    SUGGESTED_POST_PEER_INVALID: 'BadRequest.SuggestedPostPeerInvalid',
    ...
    THEME_SLUG_INVALID: 'BadRequest.ThemeSlugInvalid',
    ...
    TO_ID_INVALID: 'BadRequest.ToIdInvalid',
  ...
  403: {
    ...
    CHAT_SEND_WEBPAGE_FORBIDDEN: 'Forbidden.ChatSendWebpageForbidden',
    ...
    USER_PERMISSION_DENIED: 'Forbidden.UserPermissionDenied',
  ...
  404: {
    _: 'NotFound.NotFound',
    METHOD_INVALID: 'NotFound.MethodInvalid',
    PEER_ID_INVALID: 'NotFound.PeerIdInvalid',
  },
  406: {
    _: 'NotAcceptable.NotAcceptable',
    ALLOW_PAYMENT_REQUIRED: 'NotAcceptable.AllowPaymentRequired',
    API_GIFT_RESTRICTED_UPDATE_APP: 'NotAcceptable.ApiGiftRestrictedUpdateApp',
    ...
    STARGIFT_EXPORT_IN_PROGRESS: 'NotAcceptable.StargiftExportInProgress',
    STARS_FORM_AMOUNT_MISMATCH: 'NotAcceptable.StarsFormAmountMismatch',
    ...
    TRANSLATIONS_DISABLED: 'NotAcceptable.TranslationsDisabled',
  ...
  420: {
    ...
    FROZEN_METHOD_INVALID: 'Flood.FrozenMethodInvalid',
  ...
  500: {
    ...
    TRANSLATION_TIMEOUT: 'InternalServerError.TranslationTimeout',
